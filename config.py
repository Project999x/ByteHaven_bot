...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7482191018:AAHhyhzu3jAeqNi0eUyrYoAy-2T_NC5Haec")
...
DB_NAME = os.environ.get("DATABASE_NAME", "ByteHaven_bot")
#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002329548348"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002367727804"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002037398576"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

START_PIC = os.environ.get("START_PIC", "https://envs.sh/wXX.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/wXO.jpg")
